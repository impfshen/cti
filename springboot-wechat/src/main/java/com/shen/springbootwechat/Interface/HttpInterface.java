...
public class HttpInterface {
     ...
     * @return
     */
    public String doFlie(String url, String path) {
        URL urlObj = null;
        String result = null;
        try {
            urlObj = new URL(url);
     ...
     * @return 返回接口返回字符串出现异常则返回空
     */
    public String doPost(String url, Object boby) {
     ...
     */
    public boolean doDown(String url,String path) {
        try {
     ...
     * @return
     */
    public boolean doDown(String url,String path,String param){
        try {
            URL url1 = new URL(url);
            URLConnection urlConnection = url1.openConnection();
    ...
    private boolean write(String path,InputStream in){
